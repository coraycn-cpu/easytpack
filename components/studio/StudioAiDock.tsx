...
export default function StudioAiDock({
  ...
  return (
    <div className="pointer-events-none absolute bottom-4 left-1/2 z-40 flex -translate-x-1/2 flex-col items-center">
      <div
        className={`pointer-events-auto mb-2 flex h-[min(420px,calc(100vh-12rem))] w-[min(360px,calc(100vw-2rem))] flex-col overflow-hidden rounded-xl border border-[#2563eb] bg-white shadow-lg transition-all duration-200 ease-out ${
          open
      ...
      >
        ...
        <span className="truncate text-[11px] font-medium text-slate-700">{displayStatus}</span>
